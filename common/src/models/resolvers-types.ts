...
export type ResolversTypes = {
    ...
    Quiz: ResolverTypeWrapper<
        Omit<Quiz, "question" | "questions"> & {
            question?: Maybe<ResolversTypes["Question"]>;
            questions?: Maybe<Array<Maybe<ResolversTypes["Question"]>>>;
        }
    >;
    Sort: Sort;
...
export type ResolversParentTypes = {
    ...
    Quiz: Omit<Quiz, "question" | "questions"> & {
        question?: Maybe<ResolversParentTypes["Question"]>;
        questions?: Maybe<Array<Maybe<ResolversParentTypes["Question"]>>>;
    };
...
> = {
    ...
    >;
    addUserQuiz?: Resolver<
        Maybe<ResolversTypes["UserQuiz"]>,
        ParentType,
        ContextType,
        RequireFields<MutationAddUserQuizArgs, "input">
    >;
    deleteOption?: Resolver<
        Maybe<ResolversTypes["Option"]>,
        ParentType,
        ContextType,
        RequireFields<MutationDeleteOptionArgs, "id" | "optionID" | "quizID">
    >;
    deleteQuestion?: Resolver<
        Maybe<ResolversTypes["Question"]>,
        ParentType,
        ContextType,
        RequireFields<MutationDeleteQuestionArgs, "id" | "quizID">
    >;
    deleteQuiz?: Resolver<
        Maybe<ResolversTypes["Quiz"]>,
        ParentType,
...
> = {
    ...
    >;
    userQuiz?: Resolver<
        ResolversTypes["UserQuiz"],
        ParentType,
        ContextType,
        RequireFields<QueryUserQuizArgs, "quizID">
    >;
    userQuizzes?: Resolver<
        Array<ResolversTypes["UserQuiz"]>,
        ParentType,
        ContextType
    >;
    users?: Resolver<
...
export type UserQuizResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes["UserQuiz"] = ResolversParentTypes["UserQuiz"]
> = {
    created?: Resolver<
        Maybe<ResolversTypes["DateTime"]>,
        ParentType,
    ...
    >;
    questions?: Resolver<
        Maybe<Array<Maybe<ResolversTypes["UserQuizQuestion"]>>>,
        ParentType,
        ContextType
    >;
