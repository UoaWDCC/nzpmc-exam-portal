            ...
            <v-row>
                <v-col cols="12" md="6" class="mb-n3">
                    <div class="align-center d-flex mb-3">
                        ...
                        <v-skeleton-loader type="button" width="36" style="border-radius: 50%" />
                    </div>
                ...
                <v-col cols="12" md="6">
                    <v-skeleton-loader type="text" width="160" class="align-center d-flex"
                        style="margin-top: 12px; margin-bottom: 18px" />

                    <v-skeleton-loader v-for="i in 3" :key="i" type="list-item" height="56" class="mb-3 option-skeleton" />
                </v-col>
            </v-row>
        </v-container>
    </div>
